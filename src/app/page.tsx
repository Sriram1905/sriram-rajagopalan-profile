...
const SOCIAL_ICON_CLASSES =
  "text-text-muted transition-colors hover:text-accent-green focus-visible:text-accent-green focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-green";
...
export default function Home() {
  return (
    <>
      ...
      {/* overflow-x-clip: the hero glow extends past the right edge at narrow widths */}
      <main className="relative isolate overflow-x-clip py-16">
        {/* soft accent glow behind the hero only */}
        <div
          aria-hidden="true"
        ...
        <HeroIntro>
          ...
          <p className="mt-2 font-mono text-accent-green">
            ...
            <span
              aria-hidden="true"
              className="cursor-blink ml-1 inline-block h-[14px] w-[7px] translate-y-[2px] bg-accent-green"
            />
          </p>
          <p className="mt-4 max-w-xl text-text-muted">
            12 years across data engineering, analytics, and science. Now
            ...
            <div className="mt-4 flex flex-col gap-4 text-[15px] leading-[1.75] text-text-primary [text-align:justify] [hyphens:auto]">
              <RevealItem>
                <p>
                  ...
                  16-person science and analytics organization across the US
                  and India that supports the Amazon Books business on two
                  verticals. The first is Product and Customer Growth Science,
                  where my team owns strategy and recommendations for the
                  product organization through science-based solutions,
                  spanning customer growth, platform growth, and new launches.
                  Our scope runs end to end: owning the data infrastructure,
                  building the metrics and dashboards, and conducting science
                  deep dives and ML models that answer difficult business
                  questions and influence product strategy. The second is Risk
                  Science, where we own the Books risk and fraud domain:
                  building risk models, supporting applied science research
                  and new model launches, running deep dives that inform
                  proactive enforcement, and delivering data-backed
                  recommendations for policy.
                </p>
              </RevealItem>
              <RevealItem>
                <p>
                  I came to this role after a decade of doing the work
                  hands-on: data engineering at Capgemini, Perficient, and
                  IBM, then four-plus years at Amazon as a senior IC, building
                  the same infrastructure, metrics, and models my team owns
                  today, before stepping into management in 2024.
                </p>
              </RevealItem>
              <RevealItem>
                <p>
                  My current focus is making the organization AI-native:
                  agentic workflows that automate fraud checks, AI advisors
                  embedded in business reviews, and natural-language analytics
                  that make data self-service.
                </p>
              </RevealItem>
            </div>
          </Reveal>
